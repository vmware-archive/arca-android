...
public class ModernCursorLoader extends ModernResultLoader<CursorResult> {

	private final ForceLoadContentObserver mObserver;
	private final CursorResultTracker mTracker;

	public ModernCursorLoader(final Context context, final RequestExecutor executor, final Query request) {
