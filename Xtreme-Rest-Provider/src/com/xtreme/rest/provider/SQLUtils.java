...
public class SQLUtils {
	...
	public static String generateCreateTableStatement(final String name, final Map<String, String> mapping, final String constraint) {
	...
	public static String generateDropTableStatement(final String name) {
		return String.format("DROP TABLE IF EXISTS %s;", name);
	}

	public static String generateCreateViewStatement(final String name, final String selectStatement) {
		return String.format("CREATE VIEW IF NOT EXISTS %s AS SELECT * FROM (%s);", name, selectStatement);
	}

	public static String generateDropViewStatement(final String name) {
