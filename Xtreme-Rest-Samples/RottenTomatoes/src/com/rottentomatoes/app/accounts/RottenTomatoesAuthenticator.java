...
import com.rottentomatoes.app.activities.LauncherActivity;

public class RottenTomatoesAuthenticator extends AbstractAccountAuthenticator {

	public static final String ACCOUNT_NAME = "Rotten Tomatoes";
	public static final String ACCOUNT_TYPE = "com.rottentomatoes";
	public static final String AUTH_TOKEN_TYPE = "com.rottentomatoes.token";

	private final Context mContext;

	public RottenTomatoesAuthenticator(final Context context) {
		super(context);
		mContext = context;
	}
