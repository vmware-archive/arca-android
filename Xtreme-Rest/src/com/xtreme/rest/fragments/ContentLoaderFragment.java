 ...
 * simply by calling {@link ContentLoaderFragment#execute(ContentRequest)}.<br>
 * <br>
 * <b>IMPORTANT:</b> You MUST call the super when onViewCreated and onDestroyView is called in your fragment!<br>
 * <br>
 * <b>ALSO IMPORTANT:</b> {@link ContentLoaderFragment#execute(ContentRequest)} may only be called after onViewCreated has been called and
 * before onDestroyView has been called.
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public abstract class ContentLoaderFragment extends Fragment implements ContentLoaderListener {
