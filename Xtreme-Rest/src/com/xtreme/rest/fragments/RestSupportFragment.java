 ...
 * simply by calling {@link RestSupportFragment#execute(ContentRequest)}.<br>
 * <br>
 * <b>IMPORTANT:</b> You MUST call the super when onViewCreated and onDestroyView is called in your fragment!<br>
 * <br>
 * <b>ALSO IMPORTANT:</b> {@link RestSupportFragment#execute(ContentRequest)} may only be called after onViewCreated has been called and
 * before onDestroyView has been called.
 */
public abstract class RestSupportFragment extends Fragment implements ContentLoaderListener {
