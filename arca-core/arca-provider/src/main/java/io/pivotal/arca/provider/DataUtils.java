...
public class DataUtils {
    ...
    public static <T> ContentValues[] getContentValues(final Class<? extends SQLiteTable> klass, final List<Map<String, T>> data) throws Exception {
    ...
    public static <T> ContentValues getContentValues(final Class<? extends SQLiteTable> klass, final Map<String, T> data) {
        final ContentValues values = new ContentValues();
        try {
